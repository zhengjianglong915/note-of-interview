...
#### 4. 更加深入地了解知识背后原理
通常我们掌握的知识，仅仅是这个知识，处于一种**见树而不见森林**的状态，对其别后的原理和联系都不甚了解。于是面试中一旦面试官深入问询时，自己便回答不上了。**面试带来的好处就是让我们有更多的机会去反思和思考，让我们能够更加深入地去挖掘知识背后的原理，而不是简简单单地浮于表面的理解**。面试中你会发现那些习以为常的知识背后隐藏着一个丰富多彩的知识世界，**一花一世界，一叶一森林**，这些知识背后总有那些需要了解的知识原理和知识间的联系。通过面试，我们加强对这些知识的理解和学习，使自己能够做到**见树即见森林**。
