...
#### 3. 更加深入地了解知识背后原理
复习计算机基础知识，查缺补漏，进一步巩固之前的基础知识；面试中遇到的不会的问题便是我们成长最大、最快地方，这些问题之前学习的时候是否考虑过？是否做项目时某些问题是否有深刻的分析过？用的一些框架是否知其然而知其所以然？**面试带来的好处就是让我们有更多的机会去反思和思考，让我们能够更加深入地去挖掘知识背后的原理，而不是简简单单的浮于表面的理解**，以为会用则可。面试中你会发现那些习以为常的知识背后隐藏着一个丰富多彩的知识世界，**一花一世界，一叶一森林**。
